...
import com.shaurya.librarymanagementsystem.service.impl.AuthorServiceImpl;
...
public class AuthorServiceTest {
    ...
    void deleteAuthor_shouldThrowAuthorDeletionException_whenAuthorHasBooks() {
        Long id = 4L;
        Author existing = Author.builder().id(id).name("A").books(Set.of(new com.shaurya.librarymanagementsystem.model.entity.Book())).build();
        when(authorRepository.findById(id)).thenReturn(java.util.Optional.of(existing));
